            ...
            <div className="mt-4 container">
                <nav aria-label="breadcrumb mt-5" >
                    <ol className="breadcrumb" style={breadCrumb}>
                        ...
                        <li className="breadcrumb-item active" aria-current="page">Bloglist</li>
                    </ol>
                </nav>
                {/* search input  */}
                                    ...
                                    <div className="single-recent-blog-post card-view">
                                        <div className="thumb">
                                            <Link to={`/blog/${blog_list.slug}`} className="w-100 h-100">
                                                <hr />
                                                <img src={blog_list.thumbnail} alt={blog_list.title} style={{ minWidth: "100px", maxHeight: "210px", objectFit: "cover" }} className="card-img rounded-0 w-100"  />
                                                <hr />
                                            </Link>
